...
data:extend({
  ...
  },
  {
    ...
    results = {
      ...
      {type = "item", name = "cube-burnt-out-modular-casing", amount = 1, probability = t2_destroy_p, show_details_in_recipe_tooltip = false},
    },
  ...
  },
  {
    ...
    results = {
      ...
      {type = "item", name = "cube-burnt-out-modular-casing", amount = 1, probability = t3_destroy_p, show_details_in_recipe_tooltip = false},
    },
