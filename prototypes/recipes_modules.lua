data:extend({
  ...
  },
  {
    ...
    ingredients = {
      {"cube-inductance-module", 1},
      {"cube-spectralite", 10},
      {"cube-spectral-processor", 1},
    },
    results = {
      {type = "item", name = "cube-inductance-module-v2", amount = 1, probability = 0.1},
      {type = "item", name = "cube-inductance-module", amount = 1, probability = 0.4},
    ...
    main_product = "cube-inductance-module-v2",
    energy_required = 8,
    category = "cube-fabricator-handcraft",
    enabled = false,
  },
  {
    ...
    main_product = "cube-inductance-module-v3",
    energy_required = 12,
    category = "cube-fabricator-handcraft",
    enabled = false,
  },
  ...
  },
  {
    ...
    results = {
      ...
      {type = "item", name = "cube-compression-module", amount = 1, probability = 0.4},
      {type = "item", name = "cube-modular-casing", amount = 1, probability = 0.3},
      {type = "item", name = "cube-burnt-out-modular-casing", amount = 1, probability = 0.2},
    },
    main_product = "cube-compression-module-v2",
    energy_required = 8,
    category = "cube-fabricator-handcraft",
    enabled = false,
  },
