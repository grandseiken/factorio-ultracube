...
data:extend({
...

  {
    ...
    ingredients = {},
    results = {{type = "item", name = "cube-mechanical-network-bit-0", amount = 1}},
    energy_required = 1,
    categories = {"cube-mechanical-network-source"},
    subgroup = "cube-mechanical-network",
    order = "0[source-0]",
    hidden = true,
...

  {
    ...
    icon = "__base__/graphics/icons/signal/signal_0.png",
    icon_size = 64,
    ingredients = {{type = "item", name = "cube-mechanical-network-bit-0", amount = 1}},
    results = {},
    energy_required = 0.5,
    categories = {"cube-mechanical-network-consume"},
    subgroup = "cube-mechanical-network",
    order = "0[xor-gate-11]",
    hidden = true,
    hidden_from_player_crafting = true,
  },
  {
    ...
    icon = "__base__/graphics/icons/signal/signal_1.png",
    icon_size = 64,
    ingredients = {{type = "item", name = "cube-mechanical-network-bit-1", amount = 1}},
    results = {},
    energy_required = 0.5,
    categories = {"cube-mechanical-network-consume"},
    subgroup = "cube-mechanical-network",
