data:extend({
  ...
  },
  {
    ...
    icon_size = 128,
    ingredients = {
      {name = "cube-dormant-combustion-cube", amount = 1},
      {name = "cube-dormant-phantom-constituent", amount = 32},
    },
    results = {
  ...
  },
  {
    ...
    ingredients = {
      ...
      {name = "cube-ghost-crystal", amount = 32},
      {name = "cube-boson-conduit", amount = 32},
    },
    results = {
      {name = "cube-ultradense-combustion-cube", amount = 1, catalyst_amount = 1},
      {name = "cube-phantom-ultradense-constituent", amount = 32, catalyst_amount = 32},
    },
    main_product = "",
    energy_required = 4,
  ...
  },
  {
    ...
    icon_size = 128,
    ingredients = {
      {name = "cube-ultradense-combustion-cube", amount = 1},
      {name = "cube-phantom-ultradense-constituent", amount = 32},
    },
