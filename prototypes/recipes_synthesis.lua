data:extend({
  ...
  },
  {
    ...
    ingredients = {
      {"cube-ultradense-powder", 8},
      {type = "fluid", name = "cube-ethanol", amount = 8},
      {type = "fluid", name = "cube-mineral-water", amount = 24},
    },
    results = {
      {"cube-ultradense-mineral", 2},
  ...
  },
  {
    ...
    results = {
      {"cube-ultradense-matter-unit", 2},
      {type = "item", name = "cube-residual-tendrils", amount_min = 0, amount_max = 4},
    },
    main_product = "cube-ultradense-matter-unit",
    energy_required = 2,
  ...
  },
  {
    ...
    ingredients = {
      ...
      {type = "fluid", name = "cube-cerebral-substrate", amount = 100},
    },
    results = {{"cube-ultradense-composite", 1}},
    energy_required = 4,
