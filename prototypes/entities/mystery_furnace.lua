      ...
      working_visualisations = {
        {
          ...
          effect = "flicker",
          animation = {
            filename = "__Ultracube__/assets/furnace/mystery-furnace-fire.png",
            priority = "high",
            line_length = 8,
            width = 57,
            height = 81,
        ...
        },
        {
          ...
          effect = "flicker",
          animation = {
            filename = "__Ultracube__/assets/furnace/mystery-furnace-glow.png",
            priority = "high",
            width = 60,
            height = 43,
            frame_count = 1,
        ...
        },
        {
          ...
          effect = "flicker",
          animation = {
            filename = "__Ultracube__/assets/furnace/mystery-furnace-working.png",
            priority = "high",
            line_length = 1,
            width = 128,
            height = 150,
        ...
        },
        {
          ...
          effect = "flicker",
          animation = {
            filename = "__Ultracube__/assets/furnace/mystery-furnace-ground-light.png",
            priority = "high",
            line_length = 1,
            width = 152,
            height = 126,
