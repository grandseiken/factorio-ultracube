...
data:extend({
  {
    ...
    graphics_set = {
      animation = {
        layers = {
          {
            filename = "__krastorio2-assets-ultracube__/buildings/matter-associator/matter-associator.png",
            priority = "high",
            width = 473,
            height = 489,
            frame_count = 1,
          ...
          {
            filename = "__krastorio2-assets-ultracube__/buildings/matter-associator/matter-associator-sh.png",
            priority = "medium",
            width = 508,
            height = 446,
            frame_count = 1,
      ...
      working_visualisations = {
        {
          animation = {
            filename = "__krastorio2-assets-ultracube__/buildings/matter-associator/matter-associator-working-glow-light.png",
            priority = "high",
            draw_as_light = true,
            width = 144,
            height = 110,
        ...
        },
        {
          synced_fadeout = true,
          animation = {
            filename = "__krastorio2-assets-ultracube__/buildings/matter-associator/matter-associator-working-glow.png",
            priority = "high",
            draw_as_glow = true,
            blend_mode = "additive",
            width = 144,
        ...
        },
        {
          animation = {
            layers = {
              {
                filename = "__krastorio2-assets-ultracube__/buildings/matter-associator/matter-associator-working-light.png",
                priority = "high",
                width = 473,
                height = 489,
                frame_count = 30,
              ...
              {
                filename = "__krastorio2-assets-ultracube__/buildings/matter-associator/matter-associator-working.png",
                priority = "high",
                width = 473,
                height = 489,
                frame_count = 30,
    ...
    water_reflection = {
      pictures = {
        filename = "__krastorio2-assets-ultracube__/buildings/matter-associator/matter-associator-reflection.png",
        priority = "extra-high",
        width = 46,
        height = 46,
