...
data.raw["roboport-equipment"]["personal-roboport-mk2-equipment"].equipment_categories = {"cube-armor"}
data.raw["battery-equipment"]["battery-mk2-equipment"].equipment_categories = {"cube-armor"}