...
data.raw.item["copper-cable"].order = "1[a-conductive-wire]"
...
data.raw.item["battery"].order = "2[battery]"
data.raw.item["flying-robot-frame"].subgroup = "cube-chemical-intermediates"
data.raw.item["flying-robot-frame"].order = "4[frame]"
...
data.raw["battery-equipment"]["battery-mk2-equipment"].sprite.filename = "__Ultracube__/graphics/battery-mk2-equipment-equipment.png"
data.raw["battery-equipment"]["battery-mk2-equipment"].sprite.hr_version.filename = "__Ultracube__/graphics/hr-battery-mk2-equipment-equipment.png"