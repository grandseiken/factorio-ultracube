data:extend({
  ...
  },
  {
    ...
    category = "cube-fluid-burner",
    subgroup = "cube-fluid-burner",
    order = "cube-a[void]-d[unstable-gas]",
    hide_from_player_crafting = true,
    always_show_products = false,
    show_amount_in_title = false,
  },
