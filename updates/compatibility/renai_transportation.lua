  ...
  if (settings.startup["RTZiplineSetting"].value == true) then
    data:extend({
      ...
      },
      {
        ...
        icon_size = 64,
        effects = {
          {type = "unlock-recipe", recipe = "cube-RTZiplineRecipe"},
          {type = "unlock-recipe", recipe = "cube-RTZiplineControlsRecipe"},
        },
      ...
      },
      {
        ...
        icon_size = 64,
        effects = {
          {type = "unlock-recipe", recipe = "cube-RTZiplineCrankControlsRecipe"},
        },
      ...
      },
      {
        ...
        icon_size = 128,
        effects = {
          {type = "unlock-recipe", recipe = "cube-RTProgrammableZiplineControlsRecipe"},
          {type = "unlock-recipe", recipe = "cube-RTZiplineTerminalRecipe"},
        },
      ...
      },
      {
        ...
        effects = {
          {type = "unlock-recipe", recipe = "cube-RTZiplineRecipe2"},
        },
      ...
      },
      {
        ...
        effects = {
          {type = "unlock-recipe", recipe = "cube-RTZiplineRecipe3"},
        },
      ...
      },
      {
        ...
        effects = {
          {type = "unlock-recipe", recipe = "cube-RTZiplineRecipe4"},
        },
      ...
      },
      {
        ...
        effects = {
          {type = "unlock-recipe", recipe = "cube-RTZiplineRecipe5"},
        },
